...
const Courses = [
  {
    ...
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbC0ath_UEnQji3kztjyaxwyqSedw5txrJxQ&s",
    badges: ["Humanities"],
    level: "Beginner",
    price: { formatted: "₦9,500" },
    enrollment: { text: "180" },
    duration: "4 Weeks",
    provider: { name: "Prof. Chuka Ibe" },
  },
  {
    id: "hum102",
    title: "World History: Empires & Revolutions",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbC0ath_UEnQji3kztjyaxwyqSedw5txrJxQ&s",
    badges: ["Humanities"],
    level: "Intermediate",
  ...
  },
  {
    ...
    enrollment: { text: "95" },
    duration: "5 Weeks",
    provider: { name: "Rev. Tunde Akanji" },
  },
  {
    id: "hum104",
    title: "Contemporary African Literature",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbC0ath_UEnQji3kztjyaxwyqSedw5txrJxQ&s",
    badges: ["Humanities"],
    level: "Intermediate",
    ...
    enrollment: { text: "160" },
    duration: "5 Weeks",
    provider: { name: "Ngozi Daramola" },
  },
  {
    id: "hum105",
    title: "Sociology of Religion & Culture",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbC0ath_UEnQji3kztjyaxwyqSedw5txrJxQ&s",
    badges: ["Humanities"],
    level: "Beginner",
    ...
    enrollment: { text: "140" },
    duration: "4 Weeks",
    provider: { name: "Dr. Yusuf Agboola" },
  },
  {
    id: "hum106",
    title: "Gender Studies & Identity",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbC0ath_UEnQji3kztjyaxwyqSedw5txrJxQ&s",
    badges: ["Humanities"],
    level: "Intermediate",
  ...
  },
  {
    ...
    badges: ["Humanities"],
    level: "Beginner",
    price: { formatted: "₦8,500" },
    enrollment: { text: "230" },
    duration: "3 Weeks",
    provider: { name: "Chidi Okoroafor" },
  },
  {
    id: "hum108",
    ...
    badges: ["Humanities"],
    level: "Beginner",
    price: { formatted: "₦7,000" },
    enrollment: { text: "260" },
    duration: "4 Weeks",
    provider: { name: "Mrs. Grace Afolabi" },
  },
  {
    id: "hum109",
    ...
    enrollment: { text: "170" },
    duration: "5 Weeks",
    provider: { name: "Dr. Chika Ezenwa" },
  },
  {
    id: "hum110",
    title: "Philosophy of Education & Society",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbC0ath_UEnQji3kztjyaxwyqSedw5txrJxQ&s",
    badges: ["Humanities"],
    level: "Advanced",
    ...
    enrollment: { text: "120" },
    duration: "6 Weeks",
    provider: { name: "Prof. Olufemi Awojobi" },
  }
];
