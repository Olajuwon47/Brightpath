...
const Courses = [
  // ...Existing Business courses above,

  {
    id: "hr201",
    title: "Human Resource Management Fundamentals",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx9RMMV8snSFqoCpPhRwHknLcA50HQDWsooA&s",
    badges: ["Human Resource"],
    level: "Beginner",
    price: { formatted: "₦9,500" },
    enrollment: { text: "200" },
    duration: "4 Weeks",
    provider: { name: "Dr. Chidinma Okafor" },
  },
  {
    id: "hr202",
    title: "Talent Acquisition & Recruitment Strategies",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx9RMMV8snSFqoCpPhRwHknLcA50HQDWsooA&s",
    badges: ["Human Resource"],
    level: "Intermediate",
  ...
  },
  {
    ...
    enrollment: { text: "160" },
    duration: "6 Weeks",
    provider: { name: "Oluwaseun Adeyemi" },
  },
  {
    id: "hr204",
  ...
  },
  {
    ...
    enrollment: { text: "170" },
    duration: "5 Weeks",
    provider: { name: "Aminat Lawal" },
  },
  {
    id: "hr207",
    title: "HR Metrics & Workforce Analytics",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx9RMMV8snSFqoCpPhRwHknLcA50HQDWsooA&s",
    badges: ["Human Resource"],
    level: "Advanced",
  ...
  },
  {
    ...
    enrollment: { text: "190" },
    duration: "4 Weeks",
    provider: { name: "Ngozi Adebayo" },
  },
  {
    id: "hr209",
    title: "Labour Law & Employee Relations",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx9RMMV8snSFqoCpPhRwHknLcA50HQDWsooA&s",
    badges: ["Human Resource"],
    level: "Advanced",
    ...
    enrollment: { text: "105" },
    duration: "6 Weeks",
    provider: { name: "Barr. Musa Ibrahim" },
  },
  {
    id: "hr210",
