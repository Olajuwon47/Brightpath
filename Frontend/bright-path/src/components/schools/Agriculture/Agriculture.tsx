...
const Courses = [
...

  {
    ...
    thumbnail: "https://cdn01.alison-static.net/courses/4640/alison_courseware_intro_4640.jpg",
    badges: ["Agriculture"],
    level: "Beginner",
    price: { formatted: "₦9,000" },
    enrollment: { text: "210" },
    duration: "5 Weeks",
    provider: { name: "Engr. Musa Lawal" },
  },
  {
    id: "agri202",
  ...
  },
  {
    ...
    enrollment: { text: "110" },
    duration: "6 Weeks",
    provider: { name: "Prof. Rebecca Umeh" },
  },
  {
    id: "agri205",
    ...
    enrollment: { text: "250" },
    duration: "4 Weeks",
    provider: { name: "Emeka Nwankwo" },
  },
  {
    id: "agri206",
    title: "Agribusiness Management & Marketing",
    thumbnail: "https://cdn01.alison-static.net/courses/4640/alison_courseware_intro_4640.jpg",
    badges: ["Agriculture"],
    level: "Advanced",
    ...
    enrollment: { text: "165" },
    duration: "6 Weeks",
    provider: { name: "Mrs. Hadiza Ahmed" },
  },
  {
    id: "agri207",
    title: "Farm Accounting & Record-Keeping",
    thumbnail: "https://cdn01.alison-static.net/courses/4640/alison_courseware_intro_4640.jpg",
    badges: ["Agriculture"],
    level: "Intermediate",
    price: { formatted: "₦11,000" },
    enrollment: { text: "125" },
    duration: "5 Weeks",
    provider: { name: "Oluwaseun Adetola" },
  },
  {
    id: "agri208",
    title: "Smart Farming with IoT and Drones",
    thumbnail: "https://cdn01.alison-static.net/courses/4640/alison_courseware_intro_4640.jpg",
    badges: ["Agriculture", "Technology"],
    level: "Advanced",
    price: { formatted: "₦17,000" },
    enrollment: { text: "98" },
    duration: "7 Weeks",
    provider: { name: "Engr. Akinwale Shittu" },
  },
  {
    id: "agri209",
    ...
    enrollment: { text: "140" },
    duration: "6 Weeks",
    provider: { name: "Dr. Patience Obinna" },
  },
  {
    id: "agri210",
    title: "Post-Harvest Handling & Processing",
    thumbnail: "https://cdn01.alison-static.net/courses/4640/alison_courseware_intro_4640.jpg",
    badges: ["Agriculture"],
    level: "Advanced",
