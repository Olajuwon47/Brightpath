...
const Courses = [
  ...
  },
  {
    ...
    badges: ["Technology"],
    level: "Advanced",
    price: { formatted: "₦15,500" },
    enrollment: { text: "180" },
    duration: "6 Weeks",
    provider: { name: "Bukola James" },
  },
  {
    id: "tech106",
  ...
  },
  {
    ...
    badges: ["Technology"],
    level: "Advanced",
    price: { formatted: "₦18,500" },
    enrollment: { text: "125" },
    duration: "6 Weeks",
    provider: { name: "Ifeanyi Nwosu" },
  },
  {
    id: "tech109",
    ...
    enrollment: { text: "95" },
    duration: "6 Weeks",
    provider: { name: "Blessing Igbokwe" },
  },
  {
    id: "tech110",
    ...
    enrollment: { text: "160" },
    duration: "4 Weeks",
    provider: { name: "Dr. Kehinde Olamide" },
  }
];
