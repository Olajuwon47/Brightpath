...
const Courses = [
  ...
  {
    id: "mgmt204",
    title: "Performance Management & Appraisal Systems",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVPZrXGblbCJqj1QGjCGQVxRO3Iq9zrhQ8bA&s",
    badges: ["Management"],
    level: "Intermediate",
  ...
  },
  {
    ...
    enrollment: { text: "120" },
    duration: "6 Weeks",
    provider: { name: "Tunde Ajiboye" },
  },
  {
    id: "mgmt206",
    title: "Public Sector Management & Policy",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVPZrXGblbCJqj1QGjCGQVxRO3Iq9zrhQ8bA&s",
    badges: ["Management"],
    level: "Intermediate",
  ...
  },
  {
    ...
    enrollment: { text: "300" },
    duration: "3 Weeks",
    provider: { name: "Samuel Umeh" },
  },
  {
    id: "mgmt208",
    title: "Risk Management for Business Leaders",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVPZrXGblbCJqj1QGjCGQVxRO3Iq9zrhQ8bA&s",
    badges: ["Management"],
    level: "Advanced",
    price: { formatted: "₦17,500" },
    enrollment: { text: "100" },
    duration: "6 Weeks",
    provider: { name: "Omolara George" },
  },
  {
    id: "mgmt209",
    ...
    enrollment: { text: "140" },
    duration: "5 Weeks",
    provider: { name: "Dr. Musa Bello" },
  },
  {
    id: "mgmt210",
    title: "Team Building & Motivation Strategies",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVPZrXGblbCJqj1QGjCGQVxRO3Iq9zrhQ8bA&s",
    badges: ["Management"],
    level: "Beginner",
