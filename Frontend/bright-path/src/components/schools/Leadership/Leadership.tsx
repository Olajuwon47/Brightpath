...
const Courses = [
  ...
  {
    id: "lead204",
    title: "Transformational Leadership & Innovation",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRel6hyWi7tZ1jw2vtoYlcOz__5As4l18OCig&s",
    badges: ["Leadership"],
    level: "Advanced",
  ...
  },
  {
    ...
    enrollment: { text: "165" },
    duration: "4 Weeks",
    provider: { name: "Chinwe Olamide" },
  },
  {
    id: "lead206",
    title: "Ethical Leadership in the 21st Century",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRel6hyWi7tZ1jw2vtoYlcOz__5As4l18OCig&s",
    badges: ["Leadership"],
    level: "Beginner",
    ...
    enrollment: { text: "190" },
    duration: "4 Weeks",
    provider: { name: "Pastor Femi Aderibigbe" },
  },
  {
    id: "lead207",
    title: "Coaching & Mentoring in the Workplace",
    thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRel6hyWi7tZ1jw2vtoYlcOz__5As4l18OCig&s",
    badges: ["Leadership"],
    level: "Intermediate",
  ...
  },
  {
    ...
    enrollment: { text: "150" },
    duration: "6 Weeks",
    provider: { name: "Mrs. Adaeze Nwankwo" },
  },
  {
    id: "lead210",
    ...
    badges: ["Leadership"],
    level: "Beginner",
    price: { formatted: "₦9,800" },
    enrollment: { text: "210" },
    duration: "4 Weeks",
    provider: { name: "Ngozi Emeka-Nwosu" },
  }
];
